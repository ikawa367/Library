...
public class Book {
    ...
    public Book(String name, String author, int pages, Category input) {
        this.name = name;
        this.author = author;
        this.pages = pages;
        this.genre = input;
    ...
    public Book(String name, String author, int pages, int price, BookState situation, Category input) {
        this(name, author, pages, input);
        this.price = price;
